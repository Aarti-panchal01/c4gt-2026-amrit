...
│   └── D1-June10-26.md, D2-June11-26.md, ... (one per day)
│
├── weekly-logs/
│   ├── readme-weekly-logs.md    ← Weekly log format guide
│   └── week-01.md, week-02.md, ... (one per week)
│
└── research/
...
- [Week 1 (Jun 10–16)](weekly-logs/week-01.md) — Day 1 complete; team alignment meeting Jun 15

Week 2–13 logs will be filled as work progresses.
...
| `research/*` | Spike findings, reference code | As spikes complete |
